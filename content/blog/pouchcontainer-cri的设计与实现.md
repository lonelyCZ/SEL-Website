...
title = "PouchContainer CRI的设计与实现"
description = "本文从引入CRI的缘由而起，简要描述了CRI的架构，重点叙述了PouchContainer对CRI各个核心功能模块的实现。CRI的存在让PouchContainer容器加入Kubernetes生态变得更为简单快捷。而我们也相信，PouchContainer独有的特性必定会让Kubernetes生态变得更加丰富多彩。"
tags = ["cri","kubelet","Kubernetes","pouch"]
date = "2018-05-29 10:35:04"
author = "姚增增"
banner = "img/blogs/878/cri.png"
